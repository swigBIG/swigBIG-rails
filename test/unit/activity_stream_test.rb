...
class ActivityStreamTest < ActiveSupport::TestCase
  ...
  def test_recent_actors
    activity_streams = ActivityStream.recent_actors(bars(:aaron), 
      :public_location, 5)
  ...
  def test_find_identical_finds_identical
    ...
    activity_stream.actor_type= 'Bar'
    activity_stream.object_id= '2'
    activity_stream.object_type= 'Bar'
    ...
    as = ActivityStream.find_identical(Bar.find(1), Bar.find(2),
