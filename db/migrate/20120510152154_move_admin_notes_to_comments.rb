class MoveAdminNotesToComments < ActiveRecord::Migration
  def self.up
    remove_index  :admin_notes, :admin_user_type
    remove_index  :admin_notes, :admin_user_id
    ...
    add_index     :active_admin_comments, :author_type
    add_index     :active_admin_comments,  :author_id
  ...
  def self.down
    remove_index  :active_admin_comments, :column => :author_type
    remove_index  :active_admin_comments, :column => :author_id
